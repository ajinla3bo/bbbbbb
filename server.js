...
setInterval(() => {
  http.get(`http://system-rp-shop.glitch.me/`);
}, 280000);

const Discord = require("discord.js"); //ツⱧɆⱤØł₦ツ#0811
const client = new Discord.Client(); //ツⱧɆⱤØł₦ツ#0811
const moment = require("moment");
const jimp = require("jimp");
const Canvas = require("canvas");
const zalgo = require("zalgolize"); //ツⱧɆⱤØł₦ツ#0811
const math = require("math-expression-evaluator"); //ツⱧɆⱤØł₦ツ#0811
const figlet = require("figlet"); //ツⱧɆⱤØł₦ツ#0811
const fs = require("fs"); //ツⱧɆⱤØł₦ツ#0811
const ms = require("ms"); //ツⱧɆⱤØł₦ツ#0811
...
client.on("message", msg => {
  ...
  if (msg.content === "باك") {
    //ツⱧɆⱤØł₦ツ#0811
    msg.reply("** :wink: وِلِـكُمِـ ﻧَوِرُتْ   :sparkling_heart:**"); //ツⱧɆⱤØł₦ツ#0811
  }
});
...
client.on("message", msg => {
  ...
  if (msg.content === "السلام عليكم") {
    //ツⱧɆⱤØł₦ツ#0811
    msg.reply("**:wave:  وعليكم السلام ورحمه الله وبركاته :wave:**"); //ツⱧɆⱤØł₦ツ#0811
  }
});
...
client.on("message", msg => {
  ...
  if (msg.content === "سلام عليكم") {
    //ツⱧɆⱤØł₦ツ#0811
    msg.reply("**:wave:  وعليكم سلام ورحمه الله وبركاته :wave:**"); //ツⱧɆⱤØł₦ツ#0811
  }
});
...
client.on("message", msg => {
  ...
  if (msg.content === "كيفك") {
    //ツⱧɆⱤØł₦ツ#0811
    msg.reply("**الحمد لله وانت؟**"); //ツⱧɆⱤØł₦ツ#0811
  }
});
...
client.on("message", msg => {
  ...
  if (msg.content === "احبك") {
    //ツⱧɆⱤØł₦ツ#0811
    msg.reply("**حبك برص يا سافل**"); //ツⱧɆⱤØł₦ツ#0811
  }
});
...
client.on("message", msg => {
  ...
  if (msg.content === "هلا") {
    //ツⱧɆⱤØł₦ツ#0811
    msg.reply("**هلا بيك :heart: **"); //ツⱧɆⱤØł₦ツ#0811
  }
});
...
client.on("message", msg => {
  ...
  if (msg.content === "ip") {
    //ツⱧɆⱤØł₦ツ#0811
    msg.reply("**ip : mtasa://80.211.54.41:28915**"); //ツⱧɆⱤØł₦ツ#0811
  }
});
...
client.on("message", msg => {
  ...
  if (msg.content === "اي بي") {
 
    msg.reply("**ip : mtasa://80.211.54.41:28915**"); 
  }
});
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
client.on("message", msg => {
  ...
  if (msg.content === "قوانين") {
    //ツⱧɆⱤØł₦ツ#0811
    msg.reply("●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●");
    msg.reply("[ ★・rules | قوانين السيرفر ]");
    msg.reply("1) ممنوع السب مع اى سبب ");
    msg.reply("2)ممنوع الحديث عن الدين او سبه او مفاوضات دينيه ");
    msg.reply('3)ممنوع التحدث عن السياسه "');
    msg.reply("4)ممنوع الصور الاباحيه او اى شي مخل بالادب ");
    msg.reply("5)ممنوع نشر صور من مواقع التواصل الاجتماعى بحقوق ملكيه");
    msg.reply("6)ممنوع طلب الرتبه والرتب تكون بالتفاعل");
    msg.reply("7)لاستخدام البوت فى - #cmd");
    msg.reply("@everyone || @here");
    msg.reply("●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●");
  }
});
...
client.on("message", message => {
  if (message.channel.type == "dm" && message.author.id != client.user.id) {
    let owner = client.users.get("428819776832405546");
    let channel = client.channels.get("643932701761732619"); // ذي لو تبيه ب روم
    if (owner) {
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "v2min")) {
    //ツⱧɆⱤØł₦ツ#0811
    let args = message.content.split(" ").slice(1); //ツⱧɆⱤØł₦ツ#0811
    var nam = args.join(" ");
    ...
    if (!nam)
      return message.channel
        ...
        .then(msg => msg.delete(10000)); //ツⱧɆⱤØł₦ツ#0811
    message.guild
      .createChannel(nam, "voice")
      .then(c => setTimeout(() => c.delete(), 120000)); //ツⱧɆⱤØł₦ツ#0811
    message.channel
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "emoji")) {
    //ツⱧɆⱤØł₦ツ#0811
    if (message.author.bot) return; //ツⱧɆⱤØł₦ツ#0811
    ...
    if (emojiid.length < "18" || emojiid.length > "18" || isNaN(emojiid))
      return message.channel.send(`- Usage  //ツⱧɆⱤØł₦ツ#0811
${prefix}emoji <EmojiID>`);
    else
      message.channel.send(
        "This is the emoji that you requested:-", //ツⱧɆⱤØł₦ツ#0811
        {
          files: [`https://cdn.discordapp.com/emojis/${emojiid}.png`] //ツⱧɆⱤØł₦ツ#0811
        }
      );
  }
});
...
client.on("message", message => {
  ...
  if (message.channel.type === "dm") {
    ...
    message.channel.startTyping(); //ツⱧɆⱤØł₦ツ#0811
    setTimeout(() => {
      //ツⱧɆⱤØł₦ツ#0811
      message.channel.stopTyping(); //ツⱧɆⱤØł₦ツ#0811
    }, Math.random() * (1 - 3) + 1 * 1000); //ツⱧɆⱤØł₦ツ#0811
  }
});

const clans = {}; //ツⱧɆⱤØł₦ツ#0811
const system = {}; //ツⱧɆⱤØł₦ツ#0811
const level = {}; //ツⱧɆⱤØł₦ツ#0811

client.on("message", async message => {
  //ツⱧɆⱤØł₦ツ#0811
  if (message.author.bot) return; //ツⱧɆⱤØł₦ツ#0811
  if (message.channel.type === "dm") return; //ツⱧɆⱤØł₦ツ#0811

  let args = message.content.split(" "); //ツⱧɆⱤØł₦ツ#0811
  let random = Math.floor(Math.random() * 5) + 2; //ツⱧɆⱤØł₦ツ#0811
  let author = message.author;

  let xpLeft; //ツⱧɆⱤØł₦ツ#0811
  let nameClan; //ツⱧɆⱤØł₦ツ#0811
  let membersClan = []; //ツⱧɆⱤØł₦ツ#0811
  let levelClan = 0; //ツⱧɆⱤØł₦ツ#0811
  if (!system[author.id])
    system[author.id] = {
      clan: "None",
  ...
  if (!level[author.id]) level[author.id] = { level: 1, xp: 1 }; //ツⱧɆⱤØł₦ツ#0811

  level[author.id].xp += +random; //ツⱧɆⱤØł₦ツ#0811
  if (level[author.id].xp >= 300) {
    //ツⱧɆⱤØł₦ツ#0811
    if (level[author.id].xp > 300) xpLeft = level[author.id].xp - 300; //ツⱧɆⱤØł₦ツ#0811
    level[author.id] = {
      //ツⱧɆⱤØł₦ツ#0811
      level: level[author.id].level + 1, //ツⱧɆⱤØł₦ツ#0811
      xp: xpLeft //ツⱧɆⱤØł₦ツ#0811
    };
  }
  if (message.content.startsWith(prefix + "clan")) {
    //ツⱧɆⱤØł₦ツ#0811
    if (message.content.split(" ")[0] !== `${prefix}clan`) return; //ツⱧɆⱤØł₦ツ#0811

    if (!args[1] || (args[1] && args[1] === "info")) {
      //ツⱧɆⱤØł₦ツ#0811
      let embed = new Discord.RichEmbed()
        .setAuthor("الكلانات", message.author.avatarURL) //ツⱧɆⱤØł₦ツ#0811
        .setDescription(
  ...
  - \`${prefix}clan room\`: لعمل روم شات او كتابي بأسم الكلان ( صاحب الكلان فقط ) ء`
        ...
        .setFooter(message.author.username, message.author.avatarURL); //ツⱧɆⱤØł₦ツ#0811
      message.channel.send(embed);
    }

    if (args[1] && args[1] === "create") {
      //ツⱧɆⱤØł₦ツ#0811
      if (level[author.id].level < 10)
      ...
      let awaited = await message.channel
        ...
        .then(collected => {
          ...
          collected
            ...
            .delete()
            .catch();
          nameClan = collected.first().content; //ツⱧɆⱤØł₦ツ#0811
        });

      m = await m.edit("**# جارى عمل الكلان**"); //ツⱧɆⱤØł₦ツ#0811
      awaited = await setTimeout(async () => {
        ...
        let members = membersArray.nameClan.array; //ツⱧɆⱤØł₦ツ#0811
        members.push(message.author.id);
        clans[nameClan] = {
          name: nameClan,
          createdAt: new Date().toLocaleString(), //ツⱧɆⱤØł₦ツ#0811
          level: levelClan,
          creator: message.author.id, //ツⱧɆⱤØł₦ツ#0811
          members: members, //ツⱧɆⱤØł₦ツ#0811
          applylist: [], //ツⱧɆⱤØł₦ツ#0811
          admins: [] //ツⱧɆⱤØł₦ツ#0811  //ツⱧɆⱤØł₦ツ#0811
        };

        system[author.id] = {
          //ツⱧɆⱤØł₦ツ#0811
          clan: nameClan, //ツⱧɆⱤØł₦ツ#0811
          joinedAt: new Date().toLocaleString(), //ツⱧɆⱤØł₦ツ#0811
          clanLevel: 0, //ツⱧɆⱤØł₦ツ#0811
          creator: message.author.id //ツⱧɆⱤØł₦ツ#0811
        };

        m = await m.edit("**# تم عمل الكلان بنجاح**"); //ツⱧɆⱤØł₦ツ#0811
      }, 2300);
    }
    if (args[1] && args[1] === "invite") {
      //ツⱧɆⱤØł₦ツ#0811
      if (!system[author.id])
        return message.channel.send("**# أنت لست بكلان**"); //ツⱧɆⱤØł₦ツ#0811
      ...
      let mention = message.mentions.users.first(); //ツⱧɆⱤØł₦ツ#0811
      if (!mention) return message.channel.send("**# منشن شخص لدعوته للكلان**"); //ツⱧɆⱤØł₦ツ#0811
      if (clans[clan].members.includes(mention.id))
        return message.channel.send("**# هذا العضو بالكلان بالفعل**"); //ツⱧɆⱤØł₦ツ#0811
      if (clans[clan].members.length === 10)
        return message.channel.send(
          "**# هذا الكلان وصل للحد الاقصى من الاعضاء يمكنك**"
        ); //ツⱧɆⱤØł₦ツ#0811
      //ツⱧɆⱤØł₦ツ#0811  //ツⱧɆⱤØł₦ツ#0811  //ツⱧɆⱤØł₦ツ#0811  //ツⱧɆⱤØł₦ツ#0811  //ツⱧɆⱤØł₦ツ#0811
      ...
      let awaiting = await message.channel
        ...
        .then(collected => {
          ...
          if (collected.first().content === "نعم") {
            //ツⱧɆⱤØł₦ツ#0811
            clans[clan].members.push(mention.id); //ツⱧɆⱤØł₦ツ#0811

            system[author.id].members += 1; //ツⱧɆⱤØł₦ツ#0811
            ...
            system[mention.id] = {
              ...
              joinedAt: new Date().toLocaleString(), //ツⱧɆⱤØł₦ツ#0811
              clanLevel: 0,
              creator: clans[clan].creator //ツⱧɆⱤØł₦ツ#0811
            };

            message.channel.send(`**${message.author} # تم قبول الدعوة**`); //ツⱧɆⱤØł₦ツ#0811
          } //ツⱧɆⱤØł₦ツ#0811
          if (collected.first().content === "لا") {
            //ツⱧɆⱤØł₦ツ#0811
            message.channel.send(`**${message.author} # تم رفض الدعوة**`); //ツⱧɆⱤØł₦ツ#0811
          } else if (
            collected.first().content !== "نعم" &&
            collected.first().content !== "لا"
          ) {
            //ツⱧɆⱤØł₦ツ#0811
            return message.channel.send("**# يجب عليك كتابة `نعم` أو `لا`**"); //ツⱧɆⱤØł₦ツ#0811
          } //ツⱧɆⱤØł₦ツ#0811
        }); //ツⱧɆⱤØł₦ツ#0811
    } //ツⱧɆⱤØł₦ツ#0811
    if (args[1] && args[1] === "stats") {
      ...
      let clan = system[author.id].clan; //ツⱧɆⱤØł₦ツ#0811
      let embed = new Discord.RichEmbed() //ツⱧɆⱤØł₦ツ#0811
        .setAuthor(
          `${message.author.username} || الكلانات`,
          message.author.avatarURL
        ) //ツⱧɆⱤØł₦ツ#0811
        .setDescription(`الكلان || \`${clan.toString()}\``); //ツⱧɆⱤØł₦ツ#0811
      embed.addField("» اسم الكلان", clan, true); //ツⱧɆⱤØł₦ツ#0811
      embed.addField("» تاريخ عمل الكلان", clans[clan].createdAt, true); //ツⱧɆⱤØł₦ツ#0811
      embed.addField("» تاريخ دخول الكلان", system[author.id].joinedAt, true); //ツⱧɆⱤØł₦ツ#0811
      embed.addField("» صاحب الكلان", `<@${clans[clan].creator}>`, true); //ツⱧɆⱤØł₦ツ#0811
      embed.addField("» لفل الكلان", clans[clan].level, true); //ツⱧɆⱤØł₦ツ#0811
      embed.addField("» عدد اعضاء الكلان", clans[clan].members.length, true); //ツⱧɆⱤØł₦ツ#0811
      embed.addField(
        "» عدد التقديمات للكلان",
        clans[clan].applylist.length,
        true
      ); //ツⱧɆⱤØł₦ツ#0811
      embed.addField("» عدد الادمنية بالكلان", clans[clan].admins.length, true); //ツⱧɆⱤØł₦ツ#0811
      embed.addField(
        "» اعضاء الكلان",
        `${prefix}clan list || يظهرلك رسالة بها اعضاء الكلان`
      ); //ツⱧɆⱤØł₦ツ#0811
      message.channel.send(embed); //ツⱧɆⱤØł₦ツ#0811
    }
    if (args[1] && args[1] === "join") {
      //ツⱧɆⱤØł₦ツ#0811  //ツⱧɆⱤØł₦ツ#0811
      let clanName = message.content
        .split(" ")
        .slice(2)
        .join(" "); //ツⱧɆⱤØł₦ツ#0811
      if (system[author.id].clan !== "None")
        return message.channel.send("**# يجب أن لا تكون بكلان**"); //ツⱧɆⱤØł₦ツ#0811
      if (!args[2])
        return message.channel.send("**# يجب عليك كتابة اسم الكلان**"); //ツⱧɆⱤØł₦ツ#0811
      if (!clans[clanName])
        return message.channel.send("**# هذا الكلان غير موجود**"); //ツⱧɆⱤØł₦ツ#0811
      if (clans[clanName].applylist.includes(message.author.id))
        return message.channel.send("**# لقد قدمت على دخول هذا الكلان مسبقا"); //ツⱧɆⱤØł₦ツ#0811
      //ツⱧɆⱤØł₦ツ#0811  //ツⱧɆⱤØł₦ツ#0811  //ツⱧɆⱤØł₦ツ#0811
      clans[clanName].applylist.push(message.author.id); //ツⱧɆⱤØł₦ツ#0811
      message.channel.send(
    ...
    if (args[1] && args[1] === "accept") {
      ...
      clans[system[author.id].clan].applylist.shift(mention.id); //ツⱧɆⱤØł₦ツ#0811
      clans[system[author.id].clan].members.push(mention.id); //ツⱧɆⱤØł₦ツ#0811
      let clan = system[author.id].clan; //ツⱧɆⱤØł₦ツ#0811
    ...
    if (args[1] && args[1] === "decline") {
      ...
      system[mention.id] = {
        //ツⱧɆⱤØł₦ツ#0811
        clan: clans[system[author.id].clan], //ツⱧɆⱤØł₦ツ#0811
        joinedAt: new Date().toLocaleString(),
        clanLevel: 0 //ツⱧɆⱤØł₦ツ#0811
      };
    ...
    if (args[1] && args[1] === "promote") {
      ...
      if (system[mention.id].clan === "None")
        return message.channel.send("**# هذا الشخص ليس بكلان**"); //ツⱧɆⱤØł₦ツ#0811
      if (!clans[system[author.id].clan].members.includes(mention.id))
        return message.channel.send("**# هذا الشخص ليس بالكلان**"); //ツⱧɆⱤØł₦ツ#0811
      if (clans[system[author.id].clan].admins.includes(mention.id))
        return message.channel.send("**# هذا العضو لديه ادمن بالفعل**"); //ツⱧɆⱤØł₦ツ#0811
      if (mention.id === message.author.id)
        return message.channel.send("**# لا يمكنك اعطاء نفسك ترقية**"); //ツⱧɆⱤØł₦ツ#0811

      clans[system[author.id].clan].admins.push(mention.id); //ツⱧɆⱤØł₦ツ#0811
    ...
    if (args[1] && args[1] === "demote") {
      ...
      if (clans[system[author.id].clan].creator !== message.author.id)
        return message.channel.send("**# هذا الأمر لضاحب الكلان فقط**"); //ツⱧɆⱤØł₦ツ#0811
      if (!mention)
        return message.channel.send(
          "**# يجب عليك منشنة عضو بالكلان لأعطائه الترقية**"
        ); //ツⱧɆⱤØł₦ツ#0811
      ...
      if (!clans[system[author.id].clan].members.includes(mention.id))
        return message.channel.send("**# هذا الشخص ليس بالكلان**"); //ツⱧɆⱤØł₦ツ#0811
      if (!clans[system[author.id].clan].admins.includes(mention.id))
        return message.channel.send("**# هذا الشخص ليس ادمن بالكلان**"); //ツⱧɆⱤØł₦ツ#0811
      if (mention.id === message.author.id)
        return message.channel.send("**# لا يمكنك اعطاء نفسك ترقية**"); //ツⱧɆⱤØł₦ツ#0811
      //ツⱧɆⱤØł₦ツ#0811
      clans[system[author.id].clan].admins.shift(mention.id); //ツⱧɆⱤØł₦ツ#0811
...
client.on("message", message => {
  if (message.content == "+جمع") {
    ...
    message.channel
      .send(
        ` اول شخص يحل جمع : __**${x[x3]}**_
لديك 15 ثانية للاجابة`
      )
      .then(msg1 => {
        ...
        r.then(collected => {
          message.channel.send(
            `${collected.first().author} لقد قمت بحل جمع في الوقت المناسب  `
          );
        });
      });
  }
...
client.on("message", message => {
  if (message.content == "+طرح") {
    ...
    message.channel
      .send(
        `  اول شخص يكتب حل صح :  __**${x[x3]}**__
لديك 15 ثانية لكتابة حل صحيح`
      )
      .then(msg1 => {
        var r = message.channel.awaitMessages(msg => msg.content == x2[x3], {
          maxMatches: 1,
...
:black_circle: اوفلاين  = ${
      message.guild.members.filter(m => m.presence.status == "offline").size
    } 

:blue_circle:   الكل  = ${message.guild.memberCount}**`);
    message.channel.send({ embed });
  }
});
...
client.on("message", message => {
  ...
  if (message.content.startsWith(adminprefix + "pt")) {
    ...
    } else if (message.content.startsWith(adminprefix + "pl")) {
...
client.on("message", message => {
  if (message.content.startsWith("+عقاب")) {
    ...
    var embed = new Discord.RichEmbed()
      .setColor("PURPLE")
      .setThumbnail(message.author.avatarURL)
      .addField("Heroin36.Bot", `${Za7f[Math.floor(Math.random() * Za7f.length)]}`);
    message.channel.sendEmbed(embed);
...
client.on("message", async message => {
  ...
  if (message.content.startsWith(prefix + "mute")) {
    ...
    if (mention.id === message.author.id)
      return message.channel
        .send("**You Cannot give mute to your self :x:**")
        .then(msg => {
          msg.delete(3500);
          message.delete(3500);
        });
    ...
    mention.addRole(role).then(() => {
      ...
      message.channel.send(
        `**:ballot_box_with_check: | ${mention.user.username}  Muted !**`
      );
...
client.on("message", async message => {
  ...
  if (command === `unmute`) {
    ...
    if (!role || !kinggamer.roles.has(role.id))
      return message.channel.sendMessage(
        `**:information_source: | ${mention.user.username} is all ready unmuted**`
      );

    await kinggamer.removeRole(role);
    message.channel.sendMessage(
      `**:ballot_box_with_check: | ${mention.user.username}  UnMuted !**`
    );
...
client.on("message", async message => {
  if (message.content.startsWith(prefix + "music")) {
    ...
    let submite = message.guild.channels.find(`name`, "روم-اضافه-الاغانى");

    if (!submite)
      return message.channel.send("❌روم-اضافه-الاغانى غير موجود");
    ...
    message.channel.send("📝 **| من فضلك اكتب اسم الاغنية **").then(msg => {
      message.channel
        .awaitMessages(filter, {
          max: 1,
        ...
        .then(collected => {
          ...
          msg.edit("📜 **| اكتب رابط الاغنية (لو الاغنية مو توب فور توب غير مقبوله)ا **")
            .then(msg => {
              message.channel
                .awaitMessages(filter, {
                  max: 1,
                ...
                .then(collected => {
                  ...
                  boi = collected.first().content;
                          ...
                          msg.edit(
                            "🛡 **| هل انت متاكذ من اسم و رابط الاغنية؟ اجب ب[نعم] او [لا] وشكرا **"
                          );
                          ...
                          message.channel
                            ...
                            .then(collected => {
                              ...
                              if (collected.first().content === "نعم") {
                                ...
                                msg.edit(
                                  "🕊 **| Done ✅, تم بنجاح نشر تقديم في روم طلب اغاني**"
                                );
...
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
**[ :arrow_down: ${message.guild.name}:arrow_down: ] **
...
client.on("message", async message => {
  ...
  if (message.content.startsWith(prefix + "checkrole")) {
    if (!args) return message.reply("اكتب اسم الرتبة");
    if (!role) return message.reply("هذه الرتبة غير موجودة");
    let Heroin = new Discord.RichEmbed()
      .setAuthor(message.author.tag, message.author.avatarURL)
      .setTitle(message.guild.name)
      .setThumbnail(message.guild.iconURL)
      .addField("- اسم الرتبة", role.name)
      .addField("- عدد الاعضاء الذي لديهم نفس الرتبة", role.members.size)
      .setColor("PURPLE");

    message.channel.send(Heroin);
  }
});
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "tag")) {
    let args = message.content.split(" ").slice(1);
    if (!args[0]) return message.reply("اكتب اي شي بس لازم انجليزي");
...
**
『+ping ====>x لمعرفة سرعة اتصال البوت
『+link ====>x يسويلك رابط لمدة يوم وعدد الاستخدامات 100
『+tag ====>x لعرض الكلام بشكل جميل و كبير
『+submite ====>x للتقديم على رتبة سبورت
『+quran ====>x لعرض 200 صفحة من القرآن الكريم
『+perms ====>x لعرض صلاحياتك
『+topinv ====>x لعرض صاحب اكثر دعوات 
『+hypixel ====>x لرؤية احصائياتك في هايبكسل
『+contact ====>x للتواصل مع صاحب البوت
『+clan ====>x لعبة الكلانات
『+report ====>x للابلاغ عن احد
『+Minv ====>x لمعرفة عدد دعواتك
『+color ====>x لوضع لون لك
『+emojilist ====>x لرؤية قائمة اموجيات السيرفر
『+date ====>x يعرضلك تاريخ اليوم
『+email ====>x يعطيك ايميل و باس عشوائي
『+gRole Role name ====>x يوريك معلومات رتبة باسمها او الايدي حقها
『+bot ====>x يعرض لك كل معلومات البوت
『+say ====>x يكرر الكلام الي تكتبو
『+savatar ====>x صورة السيرفر
『+id ====>x معلومات عنك
『+new ====>x يفتح لك تكت
『+avatar ====>x صورتك او صورة الي تمنشنو
『+embed ====>x يكرر الي تقولو بشكل حلو
『+rules ====>x يعرض لك قوانين السيرفر
『+ v2min ====>x لصنع روم صوتي مؤقت
『+new ====>x لفتح تيكيت 
**
`);
...
**
『+bc ====>x رسالة لجميع اعضاء السيرفر
『+bk ====>x رسالة لجميع اعضاء السيرفر 2
『+rolebc ====>x رسالة لرتبة معينة
『+setbot ====>x لعمل روم صوتي بعدد البوتات في السيرفر
『+bans ====>x الاعضاء المبندين من سيرفرك
『+setmember ====>x لعمل روم صوتي بعدد اعضاء السيرفر
『+cto ====>x تغير الكلام في اعلى الروم
『+leave ====>x لطرد البوت من سيرفرك
『+setMedia ====>x لتحديد روم الصور
『+ranks ====>x يوريك رتب السيرفر
『+vonline ====>x لعمل روم صوتي اونلاين
『+schannel ====>x اضهار الشات المخفية
『+sr Exemple ====>x لتغيير اسم السيرفر
『+kv ====>x لطرد عضو من روم صوتي
『+hchannel ====>x اخفاء الشات
『+talk ====>x للتكلم بصفة البوت
『+count ====>x عدد اعضاء السيرفر
『+setlog ====>x لصنع روم اللوج
『+server ====>x يعرض لك معلومات عن السيرفر
『+movall ====>x لسحب الجميع الى رومك
『+sug ====>x suggestions لصنع اقتراح لازم روم 
『+bs ====>x لمعرفة سيرفرات البوت
『+rooms ====>x لرؤية رومات السيرفر
『+allbots ====>x يوريك كل البوتات في سيرفرك
『+move ====>x لسحب عضو الى روم صوتية
『+giveaway ====>x لصنع جيفواي
『+role @mention rolename ====>x لأعطاء رتبة لعضو معين
『+role all rolename ====>x لأعطاء رتبة للجميع
『+role humans rolename ====>x لأعطاء رتبة للاشخاص فقط
『+role bots rolename ====>x لأعطاء رتبة لجميع البوتات
『+members ====>x حالات اعضاء السيرفر
『+send ====>x ارسال رسالة لشخص المنشن
『+clr <numbr> ====>x مسح الشات بعدد
『+clear ====>x مسح الشات
『+mute @user <reason> ====>x اعطاء العضو ميوت لازم رتبة <Muted>
『+unmute @user ====>x لفك الميوت عن الشخص 
『+kick @user <reason> ====>x طرد الشخص من السيرفر
『+ban @user <reason> ====>x حضر الشخص من السيرفر
『+unban @user ====>x لفك حضر الشخص من السيرفر
『+mutechannel ====>x تقفيل الشات
『+unmutechannel ====>x فتح الشات
『+ct <name> ====>x انشاء شات
『+cv <name> ====>x انشاء رووم فويس
**
`);
        message.author.sendEmbed(embed);
        message.reply("تم ارسالك بلخاص");
 ...
 **       
『+8ball ====>x لعبه تسال البوت اسال  وهو يجاوب عنها
『+cuttweet ====>x لعبة كت تويت
『+هل تعلم
『+cal ====>x ألة حاسبة
『+za5 ====>x لزخرفة ما تقول
『+cats ====>x قطط كيوت
『+love ====>x يعطيك اقوال عن الحب 
『+حكم ====>x يطلعلك حكم عشوائي
『+جمع ====>x يعطيك عملية جمع ويجب حلها قبل انتهاء الواقت
『+طرح ====>x يعطيك عملية طرح ويجب حلها قبل انتهاء الوقت
『+ضرب ====>x يعطيك عملية ضرب ويجب حلها قبل انتهاء الوقت 
『+فواكه ====>x لعبة الحظ 
『+فكك ====>x لعبة التفكيك
『+sara7a ====>x لعبة صراحة
『+roll ====>x قرعة
『+xo ====>x xo لعبة 
『+نكت مضحكه ====>x نكت
『+kiss ====>x ما يحتاج شرح ههههه
『+marry ====>x لعبة الزواج
『+hack ====>x لعبه هاك
『+kill ====>x لعبة قتل
『+quas ====>x اسئلة عامة
『+لعبة مريم ====>x مريم
『+عواصم ====>x لعبة العواصم
『+يعطيك عقابات قاسية ====>x عقاب
 **
`);
        message.author.sendEmbed(embed);
        message.reply("تم ارسالك بلخاص");
      ...
      reaction4.on("collect", r => {
        const embed = new Discord.RichEmbed()
        .setThumbnail(
            "https://cdn.discordapp.com/attachments/653313843841204257/653680454251315229/imgbin-computer-icons-emoji-heart-number-music-emoji-wi4qcPHKdZS3CrvuckR8MDKMG.png"
          )
        .setColor("#000000").setDescription(`
          :musical_note:  *** __ الرومات اللازمة للبوت __*** :notes:
 **
『+p  ====>x لتشغيل الاغاني
『+pa ====>x لايقاف الاغاني
『+s  ====>x لايقاف الاغاني
...
client.on("message", msg => {
  if (msg.content.startsWith("+binv")) {
    ...
    msg.channel.send(
      `**Bot InviteURL : ** https://discordapp.com/oauth2/authorize?client_id=${user.id}&scope=bot&permissions=8`
    );
  }
});
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "sug")) {
    ...
    let Room = message.guild.channels.find(`name`, "اقــتـراحــات");
    if (!Room)
      return message.channel
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "bsug")) {
    if (message.author.bot) return;
    if (!message.guild)
      return message.reply("**:x: This Commands Just In Server**").then(v => {
        v.react("❌");
    ...
    let Room = message.guild.channels.find(`name`, "اقــتـراحــات-للبوت");
    if (!Room)
      return message.channel
        .send("Can't find suggestions channel.")
        .then(d => d.react("❌"));
...
client.on("guildMemberAdd", member => {
  var embed = new Discord.RichEmbed()
    ...
    .setDescription(
      "**# ``-`` __W__elcome __T__ø  __A____G____F__ __C__ommutiny :champagne_glass:**"
    )
    .setColor("PURPLE")
    .setImage(
      "https://2.top4top.net/p_1225y7yza1.gif",
      "https://tenor.com/view/welcome-cat-gif-5320723"
    );
...
client.on("message", message => {
  if (message.content == prefix + "slist") {
    if (!message.author.id === "428819776832405546") return;
    var gimg;
    var gname;
    var gmemb;
    var gbots;
...
client.on("message", message => {
  if (message.content.startsWith("+vsay")) {
    let args = message.content.split(" ").slice(1);
    let ar = args.join(" ");
...
client.on("message", heroin => {
  if(!heroin.channel.id == "Room ID") return;
 if(heroin.channel.id == "ROOM ID"){ 
heroin.react("✅") 
heroin.react("❎") 
 }
});
...
client.on('message', message => { 
      ...
      if(!message.channel.guild) return;
      if(!message.member.hasPermission('ADMINISTRATOR')) return message.reply('انت لا تمتلك الصلاحية');
             message.channel.overwritePermissions(message.guild.id, {
             READ_MESSAGES: false
 })
...
client.on('message', message => {
    if(message['content'].startsWith(prefix+"servers")){
        if(!message['author'].id == "516307527806484490")return message['channel'].send("You dont have permission.")//عشان ماحدا يستخد الامر غير الاونر
        var id = message['content'].split(" ")[1];
        if(!id)return message['channel'].send('Specify the server id.')
        if(isNaN(id))return message['channel'].send('Only numbers.');
        var guild = client.guilds.get(id);
        if(!guild)return message['channel'].send("I cant find this guild.")
        var embed = new Discord.RichEmbed()
        .setColor('RANDOM')
        .setTitle(`${guild.name}'s infomation`)
        .addField('Name: ', guild.name, true)
        .addField('ID: ', guild.id, true)
        .addField('Owner: ', guild.owner.user.tag, true)
        .addField('Members: ', guild.members.size, true)
        .addField('channels: ', `${guild.channels.size}\ntext: ${guild.channels.filter(c => c.type == "text").size}\nvoice: ${guild.channels.filter(c => c.type == "voice").size}`, true)
        .addField('createdAt: ', guild.createdAt, true)
        message['channel'].send(embed);
    }
})
